...
var Names = []string{PlannerSkill, TaskPlannerSkill, AuthorSkill, ReviewerSkill, VerifierSkill}

//go:embed flow-planner.md flow-task-planner.md flow-author.md flow-reviewer.md flow-verifier.md
