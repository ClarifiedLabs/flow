-- Add a provider-bound assignment provisioning scope without expanding the
-- privileges of existing diagnostic 'orchestrator' credentials. SQLite cannot
-- alter a CHECK constraint, so rebuild the table.
